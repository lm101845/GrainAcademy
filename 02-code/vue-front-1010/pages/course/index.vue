  ...
  methods:{
    ...
    initCourseFirst() {
      courseApi.getCourseList(1,8,this.searchObj).then(response => {
        ...
        console.log(response,'查询第一页数据')
        this.data = response.data.data
        console.log(this.data,'this.data111111111')
      })
    },
    ...
    initSubject() {
      courseApi.getAllSubject()
        .then(response => {
          ...
          console.log(this.subjectNestedList,'this.subjectNestedList')
        })
    },
